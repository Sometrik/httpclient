 ...
 */
void sha2_update( sha2_context *ctx, const void * input0, size_t ilen )
{
    unsigned char * input = (unsigned char *)input0;
 ...
 */
void sha2( const void *input, size_t ilen, unsigned char output[32], int is224 )
{
    sha2_context ctx;
